...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		optionRoute.Use(middleware.RootAuth())
		{
			...
			optionRoute.GET("/model-alias-groups/channels", controller.ListModelAliasGroupChannels)
			...
			optionRoute.DELETE("/model-alias-groups/channels/:channel_id/models", controller.RemoveModelAliasChannelModel)
		...
		ratioSyncRoute.Use(middleware.RootAuth())
		{
			...
			ratioSyncRoute.GET("/locks", controller.GetModelPricingLocks)
