...
func PostWssConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelName string,
	...
	if !usePrice {
		logContent = fmt.Sprintf("模型倍率 %.2f，补全倍率 %.2f，音频倍率 %.2f，音频补全倍率 %.2f，分组倍率 %.2f",
			modelRatio, relayInfo.PriceData.CompletionRatio, relayInfo.PriceData.AudioRatio, relayInfo.PriceData.AudioCompletionRatio, groupRatio)
	} else {
	...
	other := GenerateWssOtherInfo(ctx, relayInfo, usage, modelRatio, groupRatio,
		relayInfo.PriceData.CompletionRatio, relayInfo.PriceData.AudioRatio, relayInfo.PriceData.AudioCompletionRatio, modelPrice, relayInfo.PriceData.GroupRatioInfo.GroupSpecialRatio)
	if tieredResult != nil {
